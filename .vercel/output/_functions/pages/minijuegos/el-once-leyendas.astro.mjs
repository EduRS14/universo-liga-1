...
function JuegoElOnceLeyendas() {
  ...
  const agregarJugadorAlEquipo = (jugador) => {
    ...
    setErrorMsg(null);
    if (jugador.clubActual !== "No válido" && jugador.clubActual !== "Retirado") {
      setErrorMsg(`El jugador ${jugador.nombre} no está retirado y no puede ser seleccionado.`);
      return;
    }
  ...
  if (estadoJuego !== "jugando") {
    return /* @__PURE__ */ jsx("div", { className: "juego-container fade-in d-flex justify-content-center align-items-center", children: /* @__PURE__ */ jsxs("div", { className: "text-center contenedor-menu-fin", style: { border: `2px solid ${estadoJuego === "ganado" ? "#22c55e" : "#ef4444"}` }, children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "texto-explicacion-estado", children: estadoJuego === "ganado" ? "Has completado el once de leyendas correctamente." : "No lograste completar el equipo a tiempo o te rendiste." }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "juego-container fade-in", children: /* @__PURE__ */ jsx("div", { className: "container-fluid", children: /* @__PURE__ */ jsx("div", { className: "row justify-content-center align-items-center", children: /* @__PURE__ */ jsx("div", { className: "col-10 col-lg-8 contenedor-juego", children: /* @__PURE__ */ jsxs("div", { className: "row justify-content-center align-items-center", children: [
      /* @__PURE__ */ jsx("div", { className: "col-11 col-lg-6", children: /* @__PURE__ */ jsxs("div", { className: "row justify-content-center align-items-center", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "col-10 d-flex justify-content-center mt-3", children: /* @__PURE__ */ jsxs("div", { className: "turno-banner", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "turno-instruccion", children: "Coloca un jugador retirado de este equipo en cualquier posición libre." })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "col-10 panel-seleccion-container", children: slotSeleccionado ? /* @__PURE__ */ jsx("div", { className: "panel-seleccion w-100", children: /* @__PURE__ */ jsxs("div", { className: "row", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "col-12 text-center contenedor-botones-seleccion", children: [
            /* @__PURE__ */ jsx(
              "button",
              {
                onClick: () => {
          ...
          /* @__PURE__ */ jsx("p", { className: "texto-orientacion", children: "Selecciona una posición vacía (+) para agregar al jugador retirado." }),
          /* @__PURE__ */ jsx(
            "button",
            {
              className: "btn btn-danger btn-sm mt-2 btn-rendirse",
    ...
    /* @__PURE__ */ jsx("div", { className: "container-fluid", children: /* @__PURE__ */ jsx("div", { className: "row justify-content-center align-items-center", children: /* @__PURE__ */ jsx("div", { className: "col-10 col-lg-8 contenedor-descripcion-minijuego", children: /* @__PURE__ */ jsxs("div", { className: "row justify-content-center align-items-center", children: [
      /* @__PURE__ */ jsx("div", { className: "col-10 col-lg-10", children: /* @__PURE__ */ jsx("h2", { className: "titulo-descripcion-minijuego", children: "El Once - Leyendas: El Templo de la Memoria" }) }),
      /* @__PURE__ */ jsx("div", { className: "col-11 col-lg-10", children: /* @__PURE__ */ jsxs("p", { className: "texto-descripcion-minijuego", children: [
        "¿Cuántos nombres han quedado grabados en tu retina después de ver rodar la pelota por tantos años? En esta edición, el desafío rinde tributo a la ",
        /* @__PURE__ */ jsx("strong", { children: "clase eterna" }),
        ". No busques en los planteles de hoy; aquí solo juegan aquellos que ",
        /* @__PURE__ */ jsx("strong", { children: "colgaron los botines" }),
        " pero se quedaron para siempre en el recuerdo del hincha. Tu misión es rescatar del archivo a esos caudillos, magos y goleadores que marcaron una época entre ",
        /* @__PURE__ */ jsx("strong", { children: "2010 y 2025" }),
        ". El reto es de alta pureza: debes cubrir cada posición del campo usando a un solo referente por cada club histórico que aparezca en pantalla. Es un viaje nostálgico que te obligará a recordar desde aquel extranjero que fue ídolo en la selva hasta el arquero que fue muralla en una plaza de altura. Solo un verdadero conocedor de la historia reciente es capaz de ",
        /* @__PURE__ */ jsx("strong", { children: "reunir a las leyendas en una alineación de campeonato." })
      ] }) })
    ] }) }) }) })
  ] });
}
...
function MenuOnceLeyendas() {
  ...
  if (juegoIniciado && tiempo !== null && formacion !== null) {
    return /* @__PURE__ */ jsx("div", { className: "fade-in", children: /* @__PURE__ */ jsx(JuegoElOnceLeyendas, {}) });
  }
  return /* @__PURE__ */ jsx("div", { className: "contenedor-configuracion", children: /* @__PURE__ */ jsxs("div", { className: "menu-juego-leyendas-full-bg fade-in", children: [
    /* @__PURE__ */ jsx("div", { className: "leyendas-overlay-fondo" }),
    /* @__PURE__ */ jsxs("div", { className: "leyendas-contenido-contenedor", children: [
      /* @__PURE__ */ jsxs("div", { className: "leyendas-cabecera text-center mb-5", children: [
        /* @__PURE__ */ jsx("span", { className: "badge-categoria-leyendas", children: "RETO" }),
        /* @__PURE__ */ jsx("h1", { className: "titulo-hero-leyendas", children: "EL ONCE: LEYENDAS" }),
        /* @__PURE__ */ jsx("h2", { className: "subtitulo-hero-leyendas", children: "El equipo histórico definitivo" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "leyendas-cuerpo-accion text-center", children: [
        /* @__PURE__ */ jsxs("p", { className: "descripcion-juego-leyendas text-justify", children: [
          "El tiempo pasa, pero ",
          /* @__PURE__ */ jsx("strong", { children: "la clase es eterna." }),
          " En esta edición especial, tu misión es invocar a los ",
          /* @__PURE__ */ jsx("strong", { children: "ídolos de antaño" }),
          " que ya forman parte del mito. Debes armar un equipo utilizando ",
          /* @__PURE__ */ jsx("strong", { children: "un solo jugador que hay jugado en la primera división entre 2010 y 2026 y que ya esté retirado por cada club" }),
          " seleccionado. ¿Recuerdas quién era el caudillo de esa defensa que ya no existe? Es momento de rendir tributo. ",
          /* @__PURE__ */ jsx("strong", { children: "Reto ilimitado" })
        ] }),
        yaJugoHoy ? /* @__PURE__ */ jsxs("div", { className: "alerta-jugado-leyendas fade-in", children: [
          /* @__PURE__ */ jsx("span", { className: "alerta-icono-leyendas", children: "👑" }),
          /* @__PURE__ */ jsxs("p", { children: [
            "Ya armaste tu equipo histórico hoy",
            /* @__PURE__ */ jsx("br", {}),
            /* @__PURE__ */ jsx("strong", { children: "Vuelve mañana para invocar nuevas leyendas" })
          ] })
        ] }) : /* @__PURE__ */ jsxs("form", { onSubmit: handleContinuar, className: "seccion-accion-leyendas", children: [
          /* @__PURE__ */ jsxs("div", { className: "contenedor-config-tiempo", children: [
            /* @__PURE__ */ jsx("h3", { className: "titulo-config-leyendas", children: "⏱️ Selecciona tu tiempo:" }),
            /* @__PURE__ */ jsx("div", { className: "selector-tiempo-leyendas", children: TIEMPOS.map((item) => /* @__PURE__ */ jsxs("div", { className: "opcion-radio-wrapper", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "radio",
              ...
              /* @__PURE__ */ jsx("label", { htmlFor: `tiempo-${item.label}`, className: "radio-label-leyendas", children: item.label })
            ] }, item.label)) })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
...
const $$ElOnceLeyendas = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "data-astro-cid-5w7whuhs": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container-fluid" data-astro-cid-5w7whuhs> <div class="row" data-astro-cid-5w7whuhs> <div class="col-12 contenedor-titulo-calculadora" data-astro-cid-5w7whuhs> <div class="row gx-0 justify-content-center align-items-center" data-astro-cid-5w7whuhs> <div class="col-6" data-astro-cid-5w7whuhs> <h1 class="text-center titulo-calculadora" data-astro-cid-5w7whuhs>MINIJUEGO "EL ONCE - LEYENDAS"</h1> </div> </div> </div> </div> </div> ${renderComponent($$result2, "MenuOnceLeyendas", MenuOnceLeyendas, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/eduga/Desktop/Repo/universo-liga-1/src/components/minijuegos/once-leyendas/Menu-Once-Leyendas", "client:component-export": "default", "data-astro-cid-5w7whuhs": true })} ` })} `;
}, "C:/Users/eduga/Desktop/Repo/universo-liga-1/src/pages/minijuegos/el-once-leyendas.astro", void 0);

const $$file = "C:/Users/eduga/Desktop/Repo/universo-liga-1/src/pages/minijuegos/el-once-leyendas.astro";
const $$url = "/minijuegos/el-once-leyendas";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$ElOnceLeyendas,
  file: $$file,
  url: $$url
