...
function JuegoElOnceActualidad() {
  ...
  const agregarJugadorAlEquipo = (jugador) => {
    ...
    const idEquipoActual2 = nombresEquiposActuales[jugador.clubActual];
    if (!idEquipoActual2) {
      setErrorMsg(`El jugador ${jugador.nombre} no juega en la Liga 1 actualmente.`);
      return;
    }
    if (idEquipoActual2 !== equipoEsperadoId) {
  ...
  if (estadoJuego !== "jugando") {
    return /* @__PURE__ */ jsx("div", { className: "juego-container fade-in d-flex justify-content-center align-items-center", children: /* @__PURE__ */ jsxs("div", { className: "text-center contenedor-menu-fin", style: { border: `2px solid ${estadoJuego === "ganado" ? "#22c55e" : "#ef4444"}` }, children: [
      ...
      /* @__PURE__ */ jsx("p", { className: "texto-explicacion-estado", children: estadoJuego === "ganado" ? "Has completado el once de la actualidad correctamente." : "No lograste completar el equipo a tiempo o te rendiste." }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "juego-container fade-in", children: /* @__PURE__ */ jsx("div", { className: "container-fluid", children: /* @__PURE__ */ jsx("div", { className: "row justify-content-center align-items-center", children: /* @__PURE__ */ jsx("div", { className: "col-10 col-lg-8 contenedor-juego", children: /* @__PURE__ */ jsxs("div", { className: "row justify-content-center align-items-center", children: [
      /* @__PURE__ */ jsx("div", { className: "col-11 col-lg-6", children: /* @__PURE__ */ jsxs("div", { className: "row justify-content-center align-items-center", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "col-10 d-flex justify-content-center mt-3", children: /* @__PURE__ */ jsxs("div", { className: "turno-banner", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "turno-instruccion", children: "Coloca un jugador actualmente jugando en este equipo en cualquier posición libre." })
        ] }) }),
        /* @__PURE__ */ jsx("div", { className: "col-10 panel-seleccion-container", children: slotSeleccionado ? /* @__PURE__ */ jsx("div", { className: "panel-seleccion w-100", children: /* @__PURE__ */ jsxs("div", { className: "row", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "texto-orientacion", children: "Selecciona una posición vacía (+) para agregar al jugador actual." }),
          /* @__PURE__ */ jsx(
            "button",
            {
              className: "btn btn-danger btn-sm mt-2 btn-rendirse",
    ...
    /* @__PURE__ */ jsx("div", { className: "container-fluid", children: /* @__PURE__ */ jsx("div", { className: "row justify-content-center align-items-center", children: /* @__PURE__ */ jsx("div", { className: "col-10 col-lg-8 contenedor-descripcion-minijuego", children: /* @__PURE__ */ jsxs("div", { className: "row justify-content-center align-items-center", children: [
      /* @__PURE__ */ jsx("div", { className: "col-10 col-lg-10", children: /* @__PURE__ */ jsx("h2", { className: "titulo-descripcion-minijuego", children: "El Once - Actualidad: Escribe la Historia de Hoy" }) }),
      /* @__PURE__ */ jsx("div", { className: "col-11 col-lg-10", children: /* @__PURE__ */ jsxs("p", { className: "texto-descripcion-minijuego", children: [
        "El fútbol no se detiene y la ",
        /* @__PURE__ */ jsx("strong", { children: "Liga 1 2026" }),
        " ya está escribiendo sus propios mitos. En este modo, el reto es demostrar que estás conectado con lo que pasa cada fin de semana en las canchas de nuestro país. Aquí la moneda de cambio es la ",
        /* @__PURE__ */ jsx("strong", { children: "actualidad" }),
        ": desde los refuerzos que llegaron con cartel de figuras hasta los juveniles que están dando el salto este año. El cronómetro corre y los escudos de los equipos actuales te desafían a elegir con precisión quirúrgica. Debes armar tu esquema táctico seleccionando un jugador vigente por club, asegurándote de que cada pieza encaje perfectamente en su rol sobre el césped. Olvida el pasado por un momento y enfócate en el rendimiento, los fichajes y el momento de forma de los protagonistas. Es hora de demostrar que tienes ",
        /* @__PURE__ */ jsx("strong", { children: "el análisis más afinado del fútbol peruano hoy." })
      ] }) })
    ] }) }) }) })
  ] });
}
...
function MenuOnceActualidad() {
  ...
  if (juegoIniciado && tiempo !== null && formacion !== null) {
    return /* @__PURE__ */ jsx("div", { className: "fade-in", children: /* @__PURE__ */ jsx(JuegoElOnceActualidad, {}) });
  }
  return /* @__PURE__ */ jsx("div", { className: "contenedor-configuracion", children: /* @__PURE__ */ jsxs("div", { className: "menu-juego-actualidad-full-bg fade-in", children: [
    /* @__PURE__ */ jsx("div", { className: "actualidad-overlay-fondo" }),
    /* @__PURE__ */ jsxs("div", { className: "actualidad-contenido-contenedor", children: [
      /* @__PURE__ */ jsxs("div", { className: "actualidad-cabecera text-center mb-5", children: [
        /* @__PURE__ */ jsx("span", { className: "badge-categoria-actualidad", children: "RETO" }),
        /* @__PURE__ */ jsx("h1", { className: "titulo-hero-actualidad", children: "EL ONCE: ACTUALIDAD" }),
        /* @__PURE__ */ jsx("h2", { className: "subtitulo-hero-actualidad", children: "Los mejores jugadores del presente" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "actualidad-cuerpo-accion text-center", children: [
        /* @__PURE__ */ jsxs("p", { className: "descripcion-juego-actualidad text-justify", children: [
          "La pelota ya rueda y los planteles están cerrados, pero la última palabra sobre quiénes deben saltar al campo ",
          /* @__PURE__ */ jsx("strong", { children: "la tienes tú." }),
          " En esta edición, el desafío se traslada al presente absoluto. Aquí no hay espacio para la nostalgia; tu conocimiento se pone a prueba con los ",
          /* @__PURE__ */ jsx("strong", { children: "fichajes bomba, jóvenes promesas y los referentes" }),
          " que defienden hoy mismo los colores de la Primera División. ",
          /* @__PURE__ */ jsx("strong", { children: "¿Estás al día con el rendimiento actual? Reto ilimitado" })
        ] }),
        yaJugoHoy ? /* @__PURE__ */ jsxs("div", { className: "alerta-jugado-actualidad fade-in", children: [
          /* @__PURE__ */ jsx("span", { className: "alerta-icono-actualidad", children: "🔥" }),
          /* @__PURE__ */ jsxs("p", { children: [
            "Ya dirigiste el partido de hoy",
            /* @__PURE__ */ jsx("br", {}),
            /* @__PURE__ */ jsx("strong", { children: "Vuelve mañana para una nueva jornada" })
          ] })
        ] }) : /* @__PURE__ */ jsxs("form", { onSubmit: handleContinuar, className: "seccion-accion-actualidad", children: [
          /* @__PURE__ */ jsxs("div", { className: "contenedor-config-tiempo", children: [
            /* @__PURE__ */ jsx("h3", { className: "titulo-config-actualidad", children: "⏱️ Selecciona tu tiempo:" }),
            /* @__PURE__ */ jsx("div", { className: "selector-tiempo-actualidad", children: TIEMPOS.map((item) => /* @__PURE__ */ jsxs("div", { className: "opcion-radio-wrapper", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "radio",
              ...
              /* @__PURE__ */ jsx("label", { htmlFor: `tiempo-${item.label}`, className: "radio-label-actualidad", children: item.label })
            ] }, item.label)) })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
...
const $$ElOnceActualidad = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "data-astro-cid-xd6pvo6n": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="container-fluid" data-astro-cid-xd6pvo6n> <div class="row" data-astro-cid-xd6pvo6n> <div class="col-12 contenedor-titulo-calculadora" data-astro-cid-xd6pvo6n> <div class="row gx-0 justify-content-center align-items-center" data-astro-cid-xd6pvo6n> <div class="col-6" data-astro-cid-xd6pvo6n> <h1 class="text-center titulo-calculadora" data-astro-cid-xd6pvo6n>MINIJUEGO "EL ONCE - ACTUALIDAD"</h1> </div> </div> </div> </div> </div> ${renderComponent($$result2, "MenuOnceActualidad", MenuOnceActualidad, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/eduga/Desktop/Repo/universo-liga-1/src/components/minijuegos/once-actualidad/Menu-Once-Actualidad", "client:component-export": "default", "data-astro-cid-xd6pvo6n": true })} ` })} `;
}, "C:/Users/eduga/Desktop/Repo/universo-liga-1/src/pages/minijuegos/el-once-actualidad.astro", void 0);

const $$file = "C:/Users/eduga/Desktop/Repo/universo-liga-1/src/pages/minijuegos/el-once-actualidad.astro";
const $$url = "/minijuegos/el-once-actualidad";

const _page = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: $$ElOnceActualidad,
  file: $$file,
  url: $$url
