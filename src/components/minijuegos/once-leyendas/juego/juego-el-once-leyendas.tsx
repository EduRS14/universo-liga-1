          ...
          <div className="row justify-content-center align-items-center">
              ...
              <div className="col-11 col-lg-10">
                <p className="texto-descripcion-minijuego">
                  ¿Cuántos nombres han quedado grabados en tu retina después de ver rodar la pelota por tantos años? En esta edición, el desafío rinde tributo a la <strong>clase eterna</strong>. No busques en los planteles de hoy; aquí solo juegan aquellos que <strong>colgaron los botines</strong> pero se quedaron para siempre en el recuerdo del hincha. Tu misión es rescatar del archivo a esos caudillos, magos y goleadores que marcaron una época entre <strong>2010 y 2025</strong>. El reto es de alta pureza: debes cubrir cada posición del campo usando a un solo referente por cada club histórico que aparezca en pantalla. Es un viaje nostálgico que te obligará a recordar desde aquel extranjero que fue ídolo en la selva hasta el arquero que fue muralla en una plaza de altura. Solo un verdadero conocedor de la historia reciente es capaz de <strong>reunir a las leyendas en una alineación de campeonato.</strong>
                </p>
              </div>
